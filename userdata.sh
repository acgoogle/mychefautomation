...
CHEF_SERVER_NAME="MyChefAutomation" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="mychefautomation-dx5ejjqdvljgodqy.us-west-2.opsworks-cm.io" # The FQDN of your Chef Server
